...
function getAdName(consultantName)
{
  if(consultantName == "name here" || consultantName == "name here"){
      var ad = "name here";
    }
...
/*Purpose: Get the A1 notation of a cell
* Parameters: A string variable that represents the value you are looking for.
*             A string variable that represents the sheet that the value will be in. 
*             An int value of the location of the cell.
* Returns : value of the cell next to the value passed in as an array of int.
*==============================================================================*/
function getCell(searchString, sheetName, arrayLocation)
{
   //create a variable for the sheet you are searching.
   ...
   for (var i = 0; i < ilen; i++)
   {
       ...
       {
           return sheet.getRange(i + 1, 3).getA1Notation();
       }
   }
}
...
* Returns : value of the cell next to the value passed in as an array of int.
*==============================================================================*/
function findMigrationDate(searchString, sheetName, arrayLocation) {
   //create a variable for the sheet you are searching.
   var sheet = SpreadsheetApp.getActiveSpreadsheet().getSheetByName(sheetName);
